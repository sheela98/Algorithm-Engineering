...
\affiliation{%
  ...
  \country{Germany}}
\email{sheela.orgler@uni-jena.de}
...
%% Paper: Modified Adaptive Thresholding Using Integral Image
%% Method for text appearing in high and low intensity areas
%% Adaptive thresholding is a way to perform image segmentation, where an image is reduced into
%% its pixels. The segments are classified as dark or light. The goal is to make text detection
%% easier.

%% Paper: Adaptive Thresholding: A comparative study
...
% @inproceedings{peuwnuan2016modified,
%   title={Modified adaptive thresholding using integral image},
%   author={Peuwnuan, Kittipop and Woraratpanya, Kuntpong and Pasupa, Kitsuchart},
